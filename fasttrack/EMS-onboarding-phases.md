...
> [!NOTE]
> Microsoft 파트너가 Office 365 테넌트에 포함되는 경우 이 옵션이 표시되지 않습니다. Microsoft 파트너에게 지원을 요청하세요.
...
#### <a name="deploy-outlook-for-ios-and-android-securely"></a>iOS 및 Android용 Outlook을 안전하게 배포
