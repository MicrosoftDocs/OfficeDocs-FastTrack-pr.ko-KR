...
> [!NOTE]
> Windows 10 앱을 빌드하는 상업용 독립 소프트웨어 공급업체(ISV)의 경우에는 최소 라이선스 요구 사항이 없습니다. 모든 앱 요청은 현재 주요 서비스 기간 내에 있는 Windows 10 또는 Office 365 ProPlus 버전을 대상으로 해야 합니다.
