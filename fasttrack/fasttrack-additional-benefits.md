...
Exchange Online 테넌트용 라이선스를 20,000개 이상 구입한 고객은 FastTrack 센터 추가 서비스를 받을 자격이 있습니다. 자세한 내용은 [적합한 서비스 및 계획](eligible-services-and-plans.md)을 참조하세요. 
...
온보딩하는 동안 FastTrack Specialist는 다음을 수행합니다. 이러한 작업은 [FastTrack 책임](fasttrack-responsibilities.md)에 정의된 활동 외에 추가로 또는 이러한 활동 대신 수행될 수 있습니다.
...
온보딩하는 동안 다음을 수행해야 합니다. [사용자의 업무](your-responsibilities.md) 섹션에 정의된 업무 외에 다음 업무가 필요합니다. 
