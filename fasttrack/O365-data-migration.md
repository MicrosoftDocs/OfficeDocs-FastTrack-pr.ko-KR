...
#### <a name="germany-microsoft-cloud-deutschland-mcd"></a>독일 Microsoft 클라우드 독일 (MCD)

마이그레이션은 사전 정의된 마이그레이션 시간대에 하루 5시간(9x5) 기준으로 표준화된 사전 예약된 9시간 기준으로 수행됩니다. 마이그레이션이 진행될 때 하루당 하나의 마이그레이션 일괄 처리가 있습니다. UTC에서 월요일 오후 12:00시부 터 금요일 21:00시까 지 일주일에 5일의 마이그레이션 날짜가 있습니다.
...
- 정의된 방법에 대한 일정과 각 마이그레이션 이벤트에 대해 마이그레이션하는 데 필요한 특정 사용자 데이터 목록을 최소 7일 전에 제공합니다.
