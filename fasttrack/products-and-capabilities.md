...
<li>  통합 레이블 구성.  </li>
<li>  Trainable 분류자  </li>
<li>  콘텐츠 탐색기 및 작업 탐색기를 사용 하 여 데이터를 파악 합니다.  </li>
<li>  정책을 사용 하 여 레이블 게시 (수동 및 자동)  </li>
<li>  Microsoft 팀 채팅 및 채널에 대 한 DLP (데이터 손실 방지) 정책 만들기  </li>
</ul></td>
<td><strong>핵심 온 보 딩</strong> 부분 외에, <a href="#general">일반적</a>으로 최소 시스템 요구 사항은 없습니다.</td>
</tr>
<tr class="even">
...
<li>  온-프레미스 Lync 2010, Lync 2013 또는 비즈니스용 Skype 2015 서버 환경 및 비즈니스용 Skype 온라인 테넌트(해당하는 경우), 통화 계획, Skype 모임 브로드캐스트, 전화 시스템 및 통화 계획(사용 가능한 시장) 간에 분할 도메인 서버 구성을 설정합니다.  
  FastTrack은 해당 하는 경우 다음 단계를 안내 합니다.  </li>
<li>  대화방 시스템 장치 구성:
<ul>
<li>   <a href="https://go.microsoft.com/fwlink/?LinkId=615775">비즈니스용 Skype 솔루션 카탈로그</a>의 회의실 시스템 탭에 나열 된 지원 되는 회의실 장치에 필요한 온라인 계정을 만듭니다.  </li>
</ul></li>
<li>  하이브리드 및 분할 도메인 서버 구성  </li>
<li>  오디오 회의 구성:
<ul>
<li>  회의 브리지 기본 설정에 대한 조직 설정  </li>
<li>  회의 브리지를 라이선스가 있는 사용자에게 할당  </li>
...
<li>  통화 계획:
<ul>
<li>  사용자에 게 라이선스를 할당 합니다.  </li>
<li>  사용자 인터페이스를 통해 최대 99 까지의 지역 번호 이식 지침  </li>
<li>  999을 초과 하는 지역 번호 포팅 서비스 요청 지원  </li>
</ul></li>
</ul></li>
...
<li>  비즈니스용 Skype 에지 서버 역할을 포함하는 비즈니스용 Skype Server 2015 환경  </li>
  ...
  <strong>참고:</strong> 이 추가 서비스는 하이브리드 (분할 도메인) 작업을 구성 및 확인 하는 데 사용 되며, 온-프레미스 구성 요소 (예: Lync 2013 관리 도구 또는 Lync 2013/비즈니스용 Skype Online server 또는 Lync 2010, Lync 2013 또는 비즈니스용 Skype에 지 서버)는 포함 하지 않습니다.  </td>
</tr>
<tr class="even">
...
<strong>Intune을 사용하여 Configuration Manager를 클라우드에 연결</strong>  
 ...
 클라우드 연결을 사용 하는 경우 IT 관리자는 온-프레미스 환경 준비를 담당 합니다. 여기에는 Intune과 함께 Configuration Manager 환경을 클라우드로 연결 하는 것을 방지 하는 문제를 수정 하는 작업이 포함 될 수 있습니다.  
...
<td>  Windows 7 Professional 및 Windows 8.1 Professional에서 Windows 10 Enterprise로 업그레이드 하는 데 도움이 되는 지침을 제공 합니다.  
  여기서는 다음에 대 한 원격 지침을 제공 합니다.
<ul>
...
<li>  Microsoft Intune을 사용 하는 클라우드 연결 구성 관리자를 포함 하 여 최신 관리 전략을 평가 하거나 단독 클라우드 관리 솔루션으로 Intune을 배포 합니다.  </li>
...
<li>  클라우드에서 구성 관리자를 Intune에 연결 하거나 Intune 독립 실행형 (필요한 경우)을 배포 하 여 최신 관리를 사용 하도록 설정 하기 위한 지침을 제공 합니다.  </li>
</ul>
